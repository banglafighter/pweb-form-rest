...
class RESTDataCRUD(PWebCRUDCommon):
    ...
    def create(self, request_dto: PWebDataDTO, response_dto: PWebDataDTO = None, response_message: str = RESTMessage.create_success, data: dict = None):
    ...
    def update(self, request_dto: PWebDataDTO, response_dto: PWebDataDTO = None, response_message: str = RESTMessage.update_success, existing_model=None, data: dict = None, query=None):
        model = self.update_and_get_model(request_dto=request_dto, existing_model=existing_model, query=query, data=data)
        return self.message_or_data_response(model, response_dto, response_message)

    def delete(self, model_id: int, response_message: str = RESTMessage.delete_success, query=None):
        self.soft_remove(model_id=model_id, query=query)
        return self.response_maker.success_message(response_message)

    def hard_delete(self, model_id: int, response_message: str = RESTMessage.delete_success, query=None):
    ...
    def upload_file_data(self, request_dto: PWebDataDTO, upload_path, response_dto: PWebDataDTO = None, override_names: dict = None, response_message: str = RESTMessage.create_success, form_data=None):
    ...
    def update_upload_file_data(self, request_dto: PWebDataDTO, upload_path, response_dto: PWebDataDTO = None, override_names: dict = None, response_message: str = RESTMessage.update_success, existing_model=None, form_data: dict = None, query=None):
